...
public class savePlatform_Page  extends BasePage{
    ...
    public void savePlatform(String platformNew, String platformClassification, String workingTime, String platformDescription) throws InterruptedException, AWTException {
       ...
       // clickOnEmptySpace(driver);
        ...
        String imagePath = System.getProperty("C://Users//sure-//OneDrive//Desktop//Mine//Workspace//AlNasej//uploads//Uploaded.pdf");

        //String imagePath = System.getProperty("user.dir")+"/uploads/"+imageName ;
        WebElement imageUploader = driver.findElement(By.id("Union_35"));
        clickElement(imageUploader);
        Thread.sleep(2000);
